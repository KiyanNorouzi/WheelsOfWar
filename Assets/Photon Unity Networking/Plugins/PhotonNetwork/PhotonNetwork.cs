...
public static class PhotonNetwork
{
    ...
    /// </summary>
    /// <remarks>
    /// Will save the result of pinging all cloud servers in PlayerData. Calling this the first time can take +-2 seconds.
    ...
    public static bool ConnectToBestCloudServer(string gameVersion)
    {
        ...
        {
            Debug.Log("Best region found in PlayerData. Connecting to: " + bestFromPrefs);
