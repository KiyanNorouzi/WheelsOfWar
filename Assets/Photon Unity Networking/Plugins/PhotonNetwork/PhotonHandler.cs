...
internal class PhotonHandler : Photon.MonoBehaviour, IPhotonPeerListener
{
    ...
    private const string PlayerDataKey = "PUNCloudBestRegion";
    ...
    internal static CloudRegionCode BestRegionCodeInPreferences
    {
        get
        {
            string prefsRegionCode = PlayerPrefs.GetString(PlayerDataKey, "");
        ...
        set
        {
            ...
            {
                PlayerPrefs.SetString(PlayerDataKey, value.ToString());
            }
        }
    }
