...
{
    [RequireComponent(typeof(JControlledCar))]
    public class CarAudio : MonoBehaviour
    {
        ...
        private JControlledCar m_CarController; // Reference to car we are controlling


        private void StartSound()
        {
            // get the carcontroller ( this will not be null as we have require component)
            m_CarController = GetComponent<JControlledCar>();
        ...
        private void Update()
        {
            ...
            float camDist = (EnvironmentController.Instance.followCam.myTransform.position - transform.position).sqrMagnitude;
            ...
            if (m_StartedSound)
            {
                ...
                else
                {
                    ...
                    float accFade = Mathf.Abs(m_CarController.accel);
